...
const PHASES = [
  ...
  { after: 9000, text: "Taking a moment to understand you…" },
  { after: 18000, text: "Thinking this through with care…" },
  { after: 27000, text: "Almost ready, thank you for waiting…" },
  { after: 36000, text: "Your patience means a lot, hang in there…" },
];
