...
/** UTC offset in ms for APPOINTMENT_TZ at a given instant (DST-safe). */
...
/** UTC Date instant for a civil "YYYY-MM-DD" + "HH:MM" in APPOINTMENT_TZ. */
 ...
 * Both slot instants and busy intervals are compared as absolute UTC times.
 */
